...
Shader "SH/JellyfishBell"
{
	Properties
	{
		...
		_Noise("Noise", Range( 0 , 1)) = 0.07
		_DampOffset("DampOffset", Vector) = (0,0,0,0)
		_TentacleLength("TentacleLength", Range( 0.01 , 100)) = 1
	...
	SubShader
	{
		...
		uniform float3 _DampOffset;
		uniform float _TentacleLength;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float clampResult223 = clamp( ( 1.0 - (0.0 + (abs( ( ase_vertex3Pos.y + 0.5 ) ) - 0.0) * (0.5 - 0.0) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
			float temp_output_187_0 = ( ( _DeformAmount * sin( ( mulTime153 + ( ase_vertex3Pos.y * ( _VertexFreq * staticSwitch154 * temp_output_212_0 ) ) + temp_output_214_0 ) ) ) * clampResult223 );
			...
			float mulTime259 = _Time.y * 0.3;
			float3 break262 = ( ase_vertex3Pos + mulTime259 );
			float2 appendResult263 = (float2(break262.y , break262.z));
			float simplePerlin2D268 = snoise( appendResult263 );
			float2 appendResult265 = (float2(break262.x , break262.z));
			float simplePerlin2D267 = snoise( appendResult265 );
			float2 appendResult264 = (float2(break262.x , break262.z));
			float simplePerlin2D266 = snoise( appendResult264 );
			float3 appendResult269 = (float3(simplePerlin2D268 , simplePerlin2D267 , simplePerlin2D266));
			float3 noise3d270 = appendResult269;
			float temp_output_243_0 = max( ( -ase_vertex3Pos.y + -1.0 ) , 0.0 );
			float clampResult252 = clamp( temp_output_243_0 , 0.0 , 0.5 );
			float clampResult257 = clamp( ( temp_output_243_0 / _TentacleLength ) , 0.0 , 1.0 );
			v.vertex.xyz += ( appendResult174 + float4( ( ( noise3d270 * _Noise ) * clampResult252 ) , 0.0 ) + float4( ( _DampOffset * ( (float3( -0.3,-0.3,-0.3 ) + (noise3d270 - float3( 0,0,0 )) * (float3( 0.3,0.3,0.3 ) - float3( -0.3,-0.3,-0.3 )) / (float3( 1,1,1 ) - float3( 0,0,0 ))) + float3( 1,1,1 ) ) * pow( clampResult257 , 3.0 ) ) , 0.0 ) ).xyz;
		}
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_243_0 = max( ( -ase_vertex3Pos.y + -1.0 ) , 0.0 );
			float clampResult257 = clamp( ( temp_output_243_0 / _TentacleLength ) , 0.0 , 1.0 );
			float fresnelAmount278 = ( 1.0 - clampResult257 );
			float clampResult202 = clamp( ( lerpResult203 + ( smoothstepResult200 * fresnelAmount278 ) ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=16600
298;61;889;756;-6390.277;-693.5558;1.888837;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;69;719.6128,-173.6051;Float;False;Property;_PatternFactor;Pattern Factor;0;0;Create;True;0;0;False;0;0;-3.7;-10;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;258;4664.813,1789.244;Float;False;1292.292;368.6602;3D Noise;11;269;268;267;266;265;264;263;262;261;260;259;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;236;6105.37,1205.092;Float;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;259;4714.813,2002.451;Float;False;1;0;FLOAT;0.3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;148;3847.253,788.5293;Float;False;2166.797;786.7824;Comment;31;173;171;169;168;165;164;162;161;159;158;157;155;154;153;151;150;149;183;187;212;213;214;215;216;217;218;219;220;222;221;223;Vertex Deform;1,1,1,1;0;0
Node;AmplifyShaderEditor.PosVertexDataNode;260;4719.226,1859.894;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;261;4945.502,1869.115;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.NegateNode;241;6321.44,1213.622;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;238;6465.058,1201.461;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;-1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;262;5092.405,1897.139;Float;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.RangedFloatNode;275;6367.498,1352.687;Float;False;Property;_TentacleLength;TentacleLength;12;0;Create;True;0;0;False;0;1;2;0.01;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;243;6586.142,1190.304;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;265;5375.88,1927.984;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;263;5380.98,1839.244;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;264;5376.9,2025.904;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;155;4088.508,902.0269;Float;False;Property;_Speed;Speed;6;0;Create;True;0;0;False;0;5;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;268;5552.7,1887.852;Float;False;Simplex2D;1;0;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;276;6705.072,1282.775;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;267;5555.459,1954.503;Float;False;Simplex2D;1;0;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;266;5553.419,2025.904;Float;False;Simplex2D;1;0;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;269;5794.105,1943.224;Float;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ClampOpNode;257;6844.321,1230.569;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;270;5999.215,1987.771;Float;False;noise3d;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.OneMinusNode;277;7277.644,1181.416;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;223;5351.474,1041.615;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;278;7499.617,1179.151;Float;False;fresnelAmount;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;271;6398.716,848.6909;Float;False;270;noise3d;1;0;OBJECT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;233;6380.171,913.4305;Float;False;Property;_Noise;Noise;10;0;Create;True;0;0;False;0;0.07;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;200;5636.214,341.7252;Float;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;279;5665.318,586.7003;Float;False;278;fresnelAmount;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;274;6715.125,925.6022;Float;False;5;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;1,1,1;False;3;FLOAT3;-0.3,-0.3,-0.3;False;4;FLOAT3;0.3,0.3,0.3;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;187;5472.581,830.6039;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;244;7023.313,1175.117;Float;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;171;5562.473,1325.872;Float;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;280;5901.923,356.9222;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;272;6722.661,836.0224;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ClampOpNode;252;6834.313,1114.86;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;234;7028.298,917.0928;Float;False;Property;_DampOffset;DampOffset;11;0;Create;True;0;0;False;0;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleAddOpNode;273;7035.503,1049.846;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;1,1,1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;201;6062.365,304.4171;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;235;7203.419,945.7333;Float;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;232;7062.811,804.9277;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ClampOpNode;202;6374.413,292.0614;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;230;7304.554,658.1664;Float;False;3;3;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT4;0
...
WireConnection;187;1;223;0
WireConnection;244;0;257;0
...
WireConnection;280;0;200;0
WireConnection;280;1;279;0
WireConnection;272;0;271;0
WireConnection;272;1;233;0
...
WireConnection;201;1;280;0
WireConnection;235;0;234;0
WireConnection;235;1;273;0
WireConnection;235;2;244;0
WireConnection;232;0;272;0
WireConnection;232;1;252;0
...
WireConnection;137;11;230;0
ASEEND*/
//CHKSM=A437633041D24FF1D534C9045FAE4E54287CA858